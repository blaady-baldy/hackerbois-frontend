     ...
     {console.log(brandAddress)} 
      ...
      {success ? (
        ...
        <section className="addProduct" style={{ paddingBottom: "3rem" }}>
          ...
          <h1 style={{ paddingBottom: "2.25rem" }}>Issue New SBT</h1>
          ...
          <hr></hr>
          <label htmlFor="price">Enrollment No.</label>
          <input
            type="number"
            id="price"
          ...
          >
            <FontAwesomeIcon icon={faInfoCircle} />
            Enrollment No. should be a Number
          </p>
          {/* <hr></hr>
          ...
          /> */}
          <hr></hr>
          <label htmlFor="prodLink">Document Link : </label>
          <input
            type="text"
            id="prodLink"
            ref={userRef}
